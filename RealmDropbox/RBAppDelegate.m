...
//  RealmDropbox
//
//  Created by Permanote on 3/11/17.
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    [[RBDropboxSync sharedInstance] startPolling:false]; // Creates Shared Instance and starts query of Dropbox
...
- (BOOL)application:(UIApplication *)app openURL:(NSURL *)url
    ...
    DBOAuthResult * result = [DBClientsManager handleRedirectURL:url];
    switch (result.tag) {
        case DBAuthError:
            break;
        case DBAuthCancel:
